            ...
            <div style="margin-top: 5px;border-right: dashed 1px #337ab7;" class="col-md-8">
                <div style="width: 100%;">
                    ...
                    <div class="col-md-12 div-left" style="margin-top: 20px"><fmt:message key="project_name"/><%--工程名称--%>：
                        <input disabled id="proName" type="text" name="proName" value="${modelDetails.proName}"/>
                    </div>
                ...
                <div class="col-md-12 line1"></div>
                <div style="width: 100%;">
                    <div><span class="head"><fmt:message key='project_extent_damage'/><%--损坏程度--%></span></div>
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-3 col-md-9">
                <a href="modelDetail" type="button" class="btn btn-default" data-target="navTab"><fmt:message key="go_back"/> <%--返回--%></a>
            </div>
        </div>
    </div>
</form>
