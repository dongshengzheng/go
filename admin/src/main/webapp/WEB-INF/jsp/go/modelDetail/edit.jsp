            ...
            <div style="margin-top: 5px;border-right: dashed 1px #337ab7;" class="col-md-8">
                <div style="width: 100%;">
                    ...
                    <div class="col-md-12 div-left" style="margin-top: 20px"><fmt:message key="project_name"/> <%--工程名称--%>：
                        <input  id="proName" type="text" name="proName" style="width: 50%" value="${modelDetails.proName}"/>
                    </div>
                    <div class="col-md-12 div-left"><fmt:message key="project_describe"/><%--工程描述--%>： </div>
                    <div class="col-md-12" style="margin-left: 20px">
                        <textarea  class="form-control" rows="2" name="proDesc">${modelDetails.proDesc}</textarea>
                    </div>
                </div>
                ...
                <div style="width: 100%;">
                    ...
                    <div class="col-md-12 div-left" style="margin-top: 20px">
                        <div class="div-signature">
                            ...
                            <input  type="text" name="preparer" value="${modelDetails.preparer}"/>
                        </div>
                        <div class="div-signature">
                            <label>船员主管</label>
                            ...
                            <input  type="text" name="director" value="${modelDetails.director}"/>
                        </div>
                        <div class="div-signature">
                            <label>机务</label>
                            <input  type="text" name="engineer" value="${modelDetails.engineer}"/>
                        </div>
                    </div>
                </div>
            </div>
