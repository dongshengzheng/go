 ...
 */
@Controller
@RequestMapping("privateShipyard")
public class PrivateShipyardController extends BaseController{
    @Autowired
    ...
    @RequestMapping
    public String page() {
        return "go/privateShipyard/list";
    }
    ...
    public String edit(@RequestParam(required = false) Integer id, ModelMap map) {
        ...
        map.put("staticPath", staticPath);
        return "go/privateShipyard/edit";
    }
